...
maxkap = 23;%16                     % maximum value of capital grid  
minkap = -phi;                   % borrowing constraint
inckap = 0.0887;                    % size of capital grid increments
...
while test ~= 0;
   ...
   if indi == 1
      ...
      plot(kap,decis(:,1),'ro',kap,decis(:,2),'b*')
      ...
      hold on
      plot(kap,condecis(:,1),'ro',kap,condecis(:,2),'b*')
      hold off
