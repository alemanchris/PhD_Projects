function solve_age_gpu_alt(currentState::modelState_a)
...
function solve_VFI_gpu_alt(T,ne,nx,P,xgrid,egrid,ssigma,bbeta,w,r,V_tomorrow_gpu_a,V_gpu_a)
    for age = T:-1:1
        currentState = modelState_a(ne,nx,T,age,P,xgrid,egrid,ssigma,bbeta,V_tomorrow_gpu_a,w,r)
                                   (ne,nx,age,T,P,xgrid,egrid,ssigma,bbeta,V_tomorrow_gpu,w,r)
        tempV_gpu = solve_age_gpu_alt(currentState)
        V_gpu_a[age,:,:] = tempV_gpu
        V_tomorrow_gpu_a = tempV_gpu
    end
