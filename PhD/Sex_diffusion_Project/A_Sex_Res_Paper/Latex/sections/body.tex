...
\begin{tabular}{r|c}
\hline%
\textbf{Price of sex} &0.4\\
\hline
\textbf{Interest Rate} & 2.3\%\\
\hline%
\end{tabular}
\end{center}
\end{table}
...
\multicolumn{1}{c}{(a) Assets function} &  
\multicolumn{1}{c}{(b) Consumption function} \\
%\includegraphics[angle=0,width=.5\textwidth]{NewGraphs/LS_r.png}  \\ & 
%\includegraphics[angle=0,width=.5\textwidth]{NewGraphs/LS_r_IPP.png} 
\multicolumn{1}{c}{(c) Sex function} &  
\multicolumn{1}{c}{(d) Assets Distribution} \\
%\includegraphics[angle=0,width=.5\textwidth]{NewGraphs/LS_r.png}  \\ & 
%\includegraphics[angle=0,width=.5\textwidth]{NewGraphs/LS_r_IPP.png} 
\end{tabular}
\end{center}
